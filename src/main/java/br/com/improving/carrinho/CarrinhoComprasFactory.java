...
public class CarrinhoComprasFactory {
    ...
    /**
	 * Método Criar
	 * Obs: Cria e retorna um novo carrinho de compras para o cliente passado como parâmetro. Caso
	 * já exista um carrinho de compras para o cliente passado como parâmetro, este carrinho deverá ser retornado.
     */
    ...
    /**
	 * Método para retornar o valor do ticket médio
	 * Obs: Retorna o valor do ticket médio no momento da chamada ao método.
    ...
    /**
	 * Método invalidar
	 * Obs: Invalida um carrinho de compras quando o cliente faz um checkout ou sua sessão expirar.
